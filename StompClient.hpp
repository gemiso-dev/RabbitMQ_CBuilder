...
{
	virtual System::UnicodeString __fastcall Output() = 0 ;
	virtual System::TArray__1<System::Byte> __fastcall OutputBytes() = 0 ;
	...
	virtual System::TArray__1<System::Byte> __fastcall GetBytesBody() = 0 ;
	virtual void __fastcall SetBytesBody(const System::TArray__1<System::Byte> Value) = 0 ;
	__property System::TArray__1<System::Byte> BytesBody = {read=GetBytesBody, write=SetBytesBody};
...
__interface  INTERFACE_UUID("{EDE6EF1D-59EE-4FCC-9CD7-B183E606D949}") IStompClient  : public System::IInterface 
{
	...
	virtual void __fastcall Send(System::UnicodeString QueueOrTopicName, System::TArray__1<System::Byte> ByteMessage, _di_IStompHeaders Headers = _di_IStompHeaders()) = 0 /* overload */;
	virtual void __fastcall Send(System::UnicodeString QueueOrTopicName, System::TArray__1<System::Byte> ByteMessage, System::UnicodeString TransactionIdentifier, _di_IStompHeaders Headers = _di_IStompHeaders()) = 0 /* overload */;
...
public:
	...
	__classmethod _di_IStompFrame __fastcall CreateFrameWithBuffer(System::TArray__1<System::Byte> Buf)/* overload */;
